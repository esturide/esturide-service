...
from services.user_management_system.config.database import engine
from services.user_management_system.contexts.user.domain.errors import UserServiceValidationError
from services.user_management_system.contexts.user.infraestructure.router.user_router import (
    router as v2_user_router,
)
from services.user_management_system.routers.auth import router as authorization_router
from services.user_management_system.routers.automobile import router as automobile_router
from services.user_management_system.routers.drivers import router as driver_router
from services.user_management_system.routers.populate_db import router as db_router
from services.user_management_system.routers.user import router as user_router
from services.user_management_system.shared.authentication.infraestructure.router.authentication_router import (
