...
from app.services.user_management_system.contexts.user.application.service.validation_rule_factory import (
...
from app.services.user_management_system.contexts.user.domain.validation.validation_rules import (
    UniqueCURPRule,
    UniqueEmailRule,
    UserExistsRule,
)
